  ...
  return (
    <section id="pricing" className="py-20 bg-black">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-16 bg-[#75d031]/5 backdrop-blur-lg rounded-xl p-6 md:p-8 border border-[#75d031]/10 hover:border-[#75d031]/20 transition-all duration-300 max-w-4xl mx-auto">

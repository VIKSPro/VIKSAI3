      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative">
          ...
          {portfolioItems.map((item, index) => (
            <div
              key={index}
              className="group relative flex-none w-[240px] snap-center overflow-hidden rounded-xl bg-[#75d031]/5 border border-[#75d031]/10 hover:border-[#75d031]/20 transition-all duration-300"
            >
